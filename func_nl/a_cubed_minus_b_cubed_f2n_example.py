...
def create_f2n_a_cubed_minus_b_cubed_example(count: int):
    examples = []
        ...
        examples.append(
            {
                ...
                "outputStr": __random_explanation_a_cubed_minus_b_cubed(a, b),
            }
        )
    return examples


def __random_explanation_a_cubed_minus_b_cubed(a, b) -> str:
    explanations = [
