        ...
        examples.append(
            {
                ...
                "outputStr": __random_explanation_a_minus_b_whole_cubed_plus_3ab_times_a_minus_b(a, b),
            }
        )
    return examples
...
if __name__ == "__main__":
    print(
        Utility.create_sample_from_example(
            create_f2n_a_minus_b_whole_cubed_plus_3ab_times_a_minus_b_example(2), TaskTypes.FUNC_TO_NL_TRANSLATION
        )
    )
