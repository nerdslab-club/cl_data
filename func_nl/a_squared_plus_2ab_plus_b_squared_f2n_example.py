...
def create_f2n_a_squared_plus_2ab_plus_b_squared_example(count: int, identifier: int | None):
    examples = []
...
def __random_explanation_a_squared_plus_2ab_plus_b_squared(a, b, identifier: int | None) -> str:
    explanations = [
