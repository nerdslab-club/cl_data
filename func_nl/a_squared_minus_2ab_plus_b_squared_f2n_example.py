        ...
        examples.append(
            {
                ...
                "outputStr": __random_explanation_a_squared_minus_2ab_plus_b_squared(a, b),
            }
        )
    return examples
...
if __name__ == "__main__":
    print(
        Utility.create_sample_from_example(
            create_f2n_a_squared_minus_2ab_plus_b_squared_example(2), TaskTypes.FUNC_TO_NL_TRANSLATION
        )
    )
