...
def create_n2f_arcsine_example(count: int, identifier: int | None):
    ...
    for i in range(count):
        ...
        examples.append(
            {
                "inputStr": __random_explanation_arcsine(value, (None if identifier is None else identifier+i)),
...
def __random_explanation_arcsine(value: float, identifier: int | None) -> str:
