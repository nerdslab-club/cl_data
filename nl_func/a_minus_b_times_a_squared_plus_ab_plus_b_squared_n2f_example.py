...
def create_n2f_a_minus_b_times_a_squared_plus_ab_plus_b_squared_example(count: int, identifier: int | None):
    examples = []
    for i in range(count):
        ...
        examples.append({
            ...
            "outputStr": f"##a_minus_b_times_a_squared_plus_ab_plus_b_squared({a}, {b})",
        })
    return examples
...
def __random_explanation(a: int, b: int, identifier: int | None) -> str:
    explanations = [
        ...
        f"Performing the a_minus_b_times_a_squared_plus_ab_plus_b_squared operation for {a} and {b}",
        f"The expression ({a} - {b}) * ({a}^2 + {a * b} + {b}^2)",
        f"A_MINUS_B_TIMES_A_SQUARED_PLUS_AB_PLUS_B_SQUARED operation: ({a}, {b})",
        ...
        f"The result after calculating a_minus_b_times_a_squared_plus_ab_plus_b_squared for {a} and {b}",
        ...
        f"The expression ({a} - {b}) * ({a}^2 + {a * b} + {b}^2) and provide the result",
        f"A_MINUS_B_TIMES_A_SQUARED_PLUS_AB_PLUS_B_SQUARED({a}, {b}), what does it yield?",
        f"The expression ({a} - {b}) * ({a}^2 + {a * b} + {b}^2), ignoring order",
...
if __name__ == "__main__":
    print(
        Utility.create_sample_from_example(
            create_n2f_a_minus_b_times_a_squared_plus_ab_plus_b_squared_example(2),
