...
def create_n2f_a_plus_b_times_a_squared_minus_ab_plus_b_squared_example(count: int):
    examples = []
...
def __random_explanation(a: int, b: int) -> str:
    explanations = [
        ...
        f"A_PLUS_B_TIMES_A_SQUARED_MINUS_AB_PLUS_B_SQUARED operation: ({a}, {b})",
        ...
        f"A_PLUS_B_TIMES_A_SQUARED_MINUS_AB_PLUS_B_SQUARED({a}, {b}), what does it yield?",
