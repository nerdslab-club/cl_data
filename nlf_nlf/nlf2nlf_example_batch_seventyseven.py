...
def create_nlf2nlf_batch_seventyseven_example(count: int, identifier: int | None):
    examples = []
...
if __name__ == "__main__":
    print(
        Utility.create_sample_from_example(
            create_nlf2nlf_batch_seventyseven_example(2, None), TaskTypes.NL_TO_NL_TRANSLATION
        )
