...
def create_nlf2nlf_batch_one_example(count: int, identifier: int | None, seed: int,):
    examples = []
...
def __get_batch_one_example_pair(identifier: int | None, seed: int,):
    ...
    random_int_two = random_int_one + 4
    random_int_three = random_int_two + RandomValueGenerator.generate_random_integer(seed=seed)
    # random_int_four = RandomValueGenerator.generate_random_integer(seed)
    # random_float = RandomValueGenerator.generate_random_float(seed)

    examples = [
        (
            f"{random_int_one} apples and {random_int_two} oranges how many fruits in total",
            f"total number of fruits is ##addition({random_int_one},{random_int_two})",
        ),
        (
            f"{random_int_two} + {random_int_three}",
            f"result of adding {random_int_two} and {random_int_three} is ##addition({random_int_two},{random_int_three})",
        ),
        (
            f"{random_int_three} - {random_int_one}",
            f"result of subtracting {random_int_three} from {random_int_one} is ##subtraction({random_int_three},{random_int_one})",
        ),
        (
            f"{random_int_two} / {random_int_one}",
            f"result of dividing {random_int_two} by {random_int_one} is ##division({random_int_two},{random_int_one})",
        ),
        # (
        ...
        #     f"I have ##multiplication({random_int_two},{random_int_four}) pencils in total",
        # ),
        # (
        #     f"If you add {random_float} to {random_int_three} what is the resulting value",
        #     f"The result of adding {random_float} to {random_int_three} is ##addition({random_float},{random_int_three})",
        # ),
        # (
        #     f"When you take away {random_int_one} from {random_int_three} what is the outcome",
        ...
        # ),
        # (
        #     f"When you subtract {random_int_four} from {random_int_three} what is the result",
