...
def create_f2f_square_example(count: int, identifier: int | None, seed: int,):
    examples = []
...
if __name__ == "__main__":
    print(
        Utility.create_sample_from_example(
            create_f2f_square_example(2), TaskTypes.FUNC_TO_FUNC_TRANSLATION
        )
    )
