...
def create_f2f_relu_example(count: int, identifier: int | None):
    examples = []
    for i in range(count):
        num1 = RandomValueGenerator.generate_random_integer(-1000, 1000)
...
if __name__ == "__main__":
    print(
        Utility.create_sample_from_example(
            create_f2f_relu_example(2), TaskTypes.FUNC_TO_FUNC_TRANSLATION
        )
    )
