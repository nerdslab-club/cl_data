...
def create_f2f_squared_plus_example(count: int, identifier: int | None):
    examples = []
...
def __random_io_operation(num1: int, num2: int, identifier: int | None, prev_choice=None) -> str:
    explanations = [
        f"##a_plus_b_whole_square({num1}, {num2})",
        f"##a_squared_plus_2ab_plus_b_squared({num1}, {num2})",
        f"##a_minus_b_whole_squared_plus_4ab({num1}, {num2})",
    ]
...
if __name__ == "__main__":
    print(
        Utility.create_sample_from_example(
            create_f2f_squared_plus_example(2), TaskTypes.FUNC_TO_FUNC_TRANSLATION
        )
    )
