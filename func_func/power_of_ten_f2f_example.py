...
def create_f2f_power_of_ten_example(count: int, identifier: int | None):
    examples = []
...
if __name__ == "__main__":
    print(
        Utility.create_sample_from_example(
            create_f2f_power_of_ten_example(2), TaskTypes.FUNC_TO_FUNC_TRANSLATION
        )
    )
