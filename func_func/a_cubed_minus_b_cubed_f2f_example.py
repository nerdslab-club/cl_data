...
def create_f2f_cubed_minus_example(count: int, identifier: int | None):
    examples = []
...
def __random_io_operation(num1: int, num2: int, identifier: int | None, prev_choice=None) -> str:
    explanations = [
        f"##a_cubed_minus_b_cubed({num1}, {num2})",
        f"##a_minus_b_whole_cubed_plus_3ab_times_a_minus_b({num1}, {num2})",
...
if __name__ == "__main__":
    print(
        Utility.create_sample_from_example(
            create_f2f_cubed_minus_example(2), TaskTypes.FUNC_TO_FUNC_TRANSLATION
        )
    )
