...
def get_batch_three_example_paragraph():
    ...
    examples = [
        ...
        # ],
        # [
        #     "Once upon a time, in a land filled with numbers,",
        ...
        #     "In the midst of this numerical realm, a lone integer appeared:",
        #     f"{random_int_one}, a random integer with an unknown purpose.",
        #     "Then, a new integer joined the scene, its value being",
        #     f"{random_int_two}, the result of the addition of {random_int_one} and another mystery integer.",
        #     "And the story continued to unfold, as yet another integer emerged:",
        ...
        #     "And so, the tale of numbers, calculations, and mystery concludes,",
        #     "leaving behind a legacy of mathematical wonder."
        # ],
        # [
        ...
        #     "As the story concluded, the language of mathematics continued to weave its spell, revealing the beauty of numbers and the artistry of equations."
        # ],
        # [
        ...
        [
            ...
            "Their odyssey through Numberland continued, a symphony of exploration driven by their unwavering zeal for numbers and the intricate dance of calculations.",
        ]
    ]
