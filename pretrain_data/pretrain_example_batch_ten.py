...
def get_batch_ten_example_paragraph():
    ...
    examples = [
        ...
        # ],
        # [
        #     "Venture into a realm where numbers orchestrate tales and equations reveal secrets,",
        ...
        #     "Amidst this world of numbers, a lone integer stepped into the limelight:",
        #     f"{random_int_one}, an enigmatic figure, wrapped in intrigue.",
        #     "Soon after, another integer graced the stage, introduced as",
        #     f"{random_int_two}, the product of {random_int_one} combining with another concealed integer.",
        #     "As the narrative continued to unfold, another integer emerged:",
        ...
        #     "And thus, the chronicle of numbers, calculations, and enigmas neared its finale,",
        #     "leaving behind a legacy of mathematical wonder and an eternal quest for understanding."
        # ],
        # [
        ...
        #     "As our odyssey through the numerical realm nears its finale, the echoes of equations and calculations linger, leaving behind a sense of wonder and reverence for the infinite world of mathematics."
        # ],
        # [
