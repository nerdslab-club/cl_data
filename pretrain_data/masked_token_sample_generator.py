...
from cl_data.pretrain_data.pretrain_example_batch_eight import get_batch_eight_example_paragraph
from cl_data.pretrain_data.pretrain_example_batch_eleven import (
    get_batch_eleven_example_paragraph,
)
from cl_data.pretrain_data.pretrain_example_batch_five import get_batch_five_example_paragraph
from cl_data.pretrain_data.pretrain_example_batch_four import get_batch_four_example_paragraph
from cl_data.pretrain_data.pretrain_example_batch_nine import get_batch_nine_example_paragraph
from cl_data.pretrain_data.pretrain_example_batch_seven import get_batch_seven_example_paragraph
from cl_data.pretrain_data.pretrain_example_batch_six import get_batch_six_example_paragraph
from cl_data.pretrain_data.pretrain_example_batch_ten import get_batch_ten_example_paragraph
from cl_data.pretrain_data.pretrain_example_batch_three import get_batch_three_example_paragraph
from cl_data.pretrain_data.pretrain_example_batch_two import get_batch_two_example_paragraph
from cl_data.pretrain_data.pretrain_example_batch_one import get_batch_one_example_paragraph
        ...
        for key, generator in self.masked_token_example_generators.items():
            self.__masked_token_samples.extend(
                Utility.create_sample_from_example(
                    MaskedTokenSamplesGenerator.create_masked_token_batches(
                        generator(), each_example_count
                    ),
