...
def get_batch_seven_example_paragraph():
    ...
    examples = [
        ...
        # ],
        # [
        #     "Step into a world where numbers weave stories and equations unveil secrets,",
        ...
        #     "Within this numerical realm, a solitary integer emerged:",
        #     f"{random_int_one}, a figure imbued with mystique and allure.",
        #     "In the unfolding drama, a new integer took the spotlight, known as",
        #     f"{random_int_two}, the result of {random_int_one} combining with another enigmatic integer.",
        #     "The narrative continued to unfold, ushering forth another integer:",
        ...
        #     "And thus, the chronicle of numbers, calculations, and enigmas reached its finale,",
        #     "leaving behind a legacy of mathematical wonder and a perpetual quest for discovery."
        # ],
        # [
        ...
        #     "As the mathematical narrative neared its conclusion, the resonance of numbers and equations continued to echo, leaving behind a sense of wonder and appreciation for the mathematical world."
        # ],
        # [
        ...
        [
            ...
            "Their odyssey through Arithmetica endured, a symphony of exploration driven by their unyielding passion for numbers and the graceful choreography of calculations.",
        ]
    ]
