...
def get_batch_six_example_paragraph():
    ...
    examples = [
        ...
        # ],
        # [
        #     "In a realm where numbers held both secrets and revelations,",
        ...
        #     "Amidst this domain of numbers, a lone integer took center stage:",
        #     f"{random_int_one}, an enigmatic figure with untold significance.",
        #     "Soon after, another integer entered the stage, identified as",
        #     f"{random_int_two}, born from the fusion of {random_int_one} and another mysterious integer.",
        #     "As the plot unfolded, another integer came into play:",
        ...
        #     "And so, the chronicle of numbers, calculations, and enigmas gracefully concluded,",
        #     "leaving a legacy of mathematical marvels and an eternal quest for discovery."
        # ],
        # [
        ...
        #     "As the story drew to a close, the echoes of mathematical revelations lingered, whispering of the profound beauty that numbers and equations concealed."
        # ],
        # [
        ...
        [
            ...
            "Their odyssey through Numeterra endured, a symphony of exploration driven by their unwavering passion for numbers and the graceful choreography of calculations."
        ]
    ]
