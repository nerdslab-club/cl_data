...
def get_batch_nine_example_paragraph():
    ...
    examples = [
        ...
        # ],
        # [
        #     "Journey into a realm where numbers wield their magic and equations whisper secrets,",
        ...
        #     "Amidst this domain of numbers, a solitary integer took the stage:",
        #     f"{random_int_one}, an enigma wrapped in numbers.",
        #     "Soon after, another integer entered the stage, known as",
        #     f"{random_int_two}, born from the union of {random_int_one} and another cryptic number.",
        #     "As the narrative unfolded, another integer came into play:",
        ...
        #     "And so, the story of numbers, calculations, and enigmas reached its conclusion,",
        #     "leaving behind a legacy of mathematical wonder and a never-ending pursuit of knowledge."
        # ],
        # [
        ...
        #     "As our odyssey through the numerical realm nears its conclusion, the echoes of equations and calculations linger, leaving behind a sense of wonder and reverence for the boundless world of mathematics."
        # ],
        # [
        ...
        [
            ...
            "Their odyssey through Numerosia continued, a symphony of exploration driven by their unwavering passion for numbers and the graceful choreography of calculations."
        ]
    ]
