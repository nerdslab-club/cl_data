...
def get_batch_four_example_paragraph():
    ...
    examples = [
        ...
        # ],
        # [
        #     "In a land where numbers danced and equations whispered,",
        ...
        #     "Amidst this numerical realm, a solitary integer stepped into the spotlight:",
        #     f"{random_int_one}, an integer shrouded in mystery and intrigue.",
        #     "Soon after, a new integer entered the stage, its identity revealed as",
        #     f"{random_int_two}, a result of {random_int_one} harmonizing with another enigma.",
        #     "The tale continued to unfold, ushering in another integer:",
        ...
        #     "And thus, the chronicle of numbers, calculations, and enigma draws to a close,",
        #     "leaving behind a legacy of mathematical marvels and eternal curiosity."
        # ],
        # [
        ...
        #     "The tapestry of this mathematical journey unfolded, revealing the symphony of numbers and the labyrinthine beauty of equations."
        # ],
        # [
        ...
        [
            ...
            "Their odyssey through Mathopia persisted, a symphony of exploration driven by their unwavering zeal for numbers and the elegant choreography of calculations."
        ]
    ]
