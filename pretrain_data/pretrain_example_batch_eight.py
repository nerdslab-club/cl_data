...
def __get_batch_eight_example_paragraph():
    ...
    examples = [
        ...
        # ],
        # [
        #     "Step into a realm where numbers hold secrets and equations reveal tales,",
        ...
        #     "Amidst this domain of numbers, a lone integer took the stage:",
        #     f"{random_int_one}, an enigmatic figure with untold significance.",
        #     "Soon after, another integer made its appearance, identified as",
        #     f"{random_int_two}, the outcome of {random_int_one} merging with another concealed integer.",
        #     "As the plot unfolded, another integer emerged:",
        ...
        #     "And so, the chronicle of numbers, calculations, and enigmas drew to its final chapter,",
        #     "leaving behind a legacy of mathematical marvels and an eternal journey of exploration."
        # ],
        # [
        ...
        #     "As our journey through the tapestry of mathematics nears its conclusion, the echoes of equations and calculations resonate, leaving us with an enduring sense of awe and reverence for the world of numbers."
        # ],
        # [
